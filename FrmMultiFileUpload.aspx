<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="FrmMultiFileUpload.aspx.cs" Inherits="FrmMultiFileUpload" %>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-md-12">
                                <asp:Button OnClientClick="return CheckFUpload()" CssClass="btn btn-primary"
                                    ...
                                    Text="Save" ID="btnSave" OnClick="btnSave_Click" runat="server" Visible="false" />
    ...
    <div class="modal fade" id="modalConfirmation" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" >
                    <h6>Data Successfully Import Do You Want To Continue</h6>
                </div>
